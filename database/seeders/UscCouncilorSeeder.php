...
class UscCouncilorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $usc_councilors = [
            ...
            ["name" => "AUDIE JAY ANTE", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Education"],
            ["name" => "CARLA ISABEL ARIOLA", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Education"],
            ["name" => "HAVEN KERBIE MORALES", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "JOY ANN MILLENA", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "JULIUS SALVADOR MACANDOG", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "MARIANNE JOICE BOS", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "Institute of Design and Architecture"],
            ["name" => "MARK FELIX MAGDARAOG", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Business, Economics, and Management"],
            ["name" => "MARY LOURDES RANERA", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "ROGIELYN PAJARA", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Engineering"],
            ["name" => "SHANE MAE BURCE", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "STEPHEN FRANK MERCED", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "VENICE CADAG", "type" => "Public Relations Committee 😊 Content Creation Sub-Committee", "college" => "Jesse M. Robredo Institute of Governance and Development"],

            // Public Relations Committee 😊 Social Media Management Sub-Committee
            ["name" => "AARON BERNETTE BERJUEGA", "type" => "Public Relations Committee 😊 Social Media Management Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "MARK ORLY DOTE", "type" => "Public Relations Committee 😊 Social Media Management Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "YUNISE ELLAINE MADRIÑAN", "type" => "Public Relations Committee 😊 Social Media Management Sub-Committee", "college" => "College of Science"],

            // Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee
            ["name" => "ALLYSA GIME", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "AUDREY MAXENE BUASAN", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "GELOU ROBERT RAZON", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "BU Polangui"],
            ["name" => "MARY YLAINE JOY AVILA", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "BU Tabaco"],
            ["name" => "MILES OWEN VALLADOLID", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "College of Nursing"],
            ["name" => "PAUL DARRYL ESCANDOR", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "College of Industrial Technology"],
            ["name" => "RUSSEL FRESNIDO", "type" => "Public Relations Committee 😊 Visual Content and Graphic Design Sub-Committee", "college" => "College of Education"],

            // Public Relations Committee 😊 Event Documentation Sub-Committee
            ["name" => "ALYSSANDRA RECEPCION", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Nursing"],
            ["name" => "DARLENE ANGEL MARANTAL", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Social Sciences and Philosophy"],
            ["name" => "ELNY JEAM JIMENEZ", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "FRANCHEZKA SONCUYA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Business, Economics, and Management"],
            ["name" => "FRANCIS JOHN MARIC BIEN", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "Institute of Design and Architecture"],
            ["name" => "JAN ANDRE ESCUETA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Dental Medicine"],
            ["name" => "JETHRO YÑIGO BETUDIO", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Business, Economics, and Management"],
            ["name" => "JEYZETH EURIEL VILLAMOR", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "Jesse M. Robredo Institute of Governance and Development"],
            ["name" => "JOHN VINCENT BERJUELA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "BU Polangui"],
            ["name" => "JOVELYN LANZUELA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "JULIUS CAESAR DE PADUA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Dental Medicine"],
            ["name" => "JULLIAN LAURENCE MORATILLO", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Business, Economics, and Management"],
            ["name" => "SOPHIA MAE CRUZ", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "College of Arts and Letters"],
            ["name" => "VINCENT LITA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "Institute of Design and Architecture"],
            ["name" => "MARIA ANGEL ZUNIEGA", "type" => "Public Relations Committee 😊 Event Documentation Sub-Committee", "college" => "BU Polangui"],

            // Technical Production Sub-Committee
            ["name" => "CARL JUSTINE LLAGUNO", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Industrial Technology"],
            ["name" => "CESPHILLIP LORICA", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Science"],
            ["name" => "JEHANN ROSE JARME", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Business, Economics, and Management"],
            ["name" => "JOHN LLOYD CUARIO", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Science"],
            ["name" => "JULIA MAE MENDEZ", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Education"],
            ["name" => "KRISTINE HABALO", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Education"],
            ["name" => "VINCE ECHIN", "type" => "Public Relations Committee 😊 Technical Production Sub-Committee", "college" => "College of Arts and Letters"],
        ];
